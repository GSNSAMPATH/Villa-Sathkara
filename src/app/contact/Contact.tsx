            ...
            <div className="bg-white w-full flex flex-col  items-center ">
                <section className="relative w-full h-[40vh] sm:h-[60vh] lg:h-[80vh] rounded-2xl overflow-hidden">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50 text-center sm:px-4 md:px-24">
                        ...
                        <p className="relative font-[poppins] font-semibold text-[10px] sm:text-[16px] md:text-[20px] top-1/3 md:top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  text-white text-center md:px-2 lg:px-24 px-4">Whether you’re planning your next holiday, have questions about our villa, or need help arranging transfers and activities, we’re always happy to assist. Reach out to us today and let us make your stay in Tangalle effortless and unforgettable.</p>
                    </div>
                </section>
                ...
                <section className="py-2 sm:px-6 md:px-8 lg:px-20  mt-[100px]">
                    <div className=" mx-auto grid grid-cols-1 md:grid-cols-2 rounded-2xl overflow-hidden shadow-lg">
                        ...
                        <div className="bg-gray-100 p-6 md:p-10 order-1 md:order-2 ">
                           ...
                           <form onSubmit={handleSubmit} className="space-y-10  lg:px-8 bg-gray-100">
                            {/* Name Fields */}
