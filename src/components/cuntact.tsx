    ...
    return (
        <section className="py-16 px-0 lg:px-30 bg-white w-full md:mt-20 mt-10">
            <div className="text-center mb-12">
                <h2 className="font-[Poppins] font-semibold text-[16px] md:text-[36px] font-semibold text-gray-800">Get in Touch with Villa Sathkara</h2>
            ...
            className="flex items-center justify-center gap-2 bg-gray-800 md:px-6 md:py-3 py-2 w-full md:w-[300px] rounded-3xl hover:bg-[#1B3A57] text-white font-semibold transition-colors duration-200"
            >
